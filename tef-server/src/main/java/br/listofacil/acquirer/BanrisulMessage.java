...
public class BanrisulMessage {
	...
	private ISOMsg getMessage0200(TransactionData requestData) throws ISOException {
		...
		//Devemos enviar o BIT023 para cartoes Banrisul mesmo que o valor esteja = "000"
		if ((requestData.panSequence.length() > 0) &&
			((Integer.parseInt(requestData.panSequence) > 0) || requestData.productDescription.contains("BANRISUL")))
